...
const services = [
  {
    ...
    deliverables: ['Brand Positioning', 'Competitive Analysis', 'Brand Architecture', 'Naming', 'Brand Voice & Tone'],
  },
  {
    number: '02',
    name: 'Brand Identity',
    ...
    deliverables: ['Logo System', 'Typography', 'Colour Palette', 'Visual Language', 'Brand Guidelines'],
  },
  {
    number: '03',
    ...
    deliverables: ['UX Strategy', 'UI Design', 'Next.js Development', 'Framer Sites', 'CMS Integration'],
  },
  {
    number: '04',
    ...
    deliverables: ['Google Ads', 'Meta Ads', 'SEO', 'Analytics Setup', 'Campaign Strategy'],
  },
  {
    number: '05',
    name: 'Social Media',
    ...
    deliverables: ['Content Strategy', 'Visual Templates', 'Content Calendar', 'Caption Writing', 'Profile Optimisation'],
  },
  {
    number: '06',
    name: 'Graphic Design',
    ...
    deliverables: ['Print Collateral', 'Packaging', 'Pitch Decks', 'Marketing Materials', 'Event Branding'],
  },
]
        ...
        <div className="pt-36 pb-20 px-5 sm:px-8 lg:px-12 border-b border-[#1a1a1a]/6">
          <div className="max-w-[1200px] mx-auto">
            ...
            <p className="text-base text-[#777] max-w-[440px]" style={{ fontFamily: 'var(--font-inter)' }}>
              Strategy-led. Identity-driven. Built to make ambitious brands impossible to ignore.
            </p>
          </div>
        </div>
        ...
        <div className="px-5 sm:px-8 lg:px-12">
          <div className="max-w-[1200px] mx-auto">
            {services.map((service, i) => (
              <div
                key={service.number}
                className={`group py-12 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 border-b border-[#1a1a1a]/6 transition-colors duration-300 hover:bg-[#faf9f6] -mx-5 sm:-mx-8 lg:-mx-12 px-5 sm:px-8 lg:px-12`}
              >
                {/* Number + Name */}
                <div className="lg:col-span-5 flex items-start gap-6">
                  <span
                    className="text-[11px] font-semibold text-[#1a1a1a]/20 mt-1.5 tabular-nums flex-shrink-0 font-[family-name:var(--font-inter)] group-hover:text-[#f05a28] transition-colors duration-300"
                  >
                    {service.number}
                  </span>
                  <h2
